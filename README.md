# QuickInvoice
QuickInvoice is a user-friendly invoicing application designed to streamline the invoicing process for businesses of all sizes. Whether you're a freelancer, contractor, or a small business owner, Invoicely simplifies the task of creating, and managing invoices. 🚀
...
### Installation 🛠️
Once you have the repository cloned, open the terminal run the backend server.
```bash
cd backend
nodemon server.js
```
...
### Environment 🌐
Developed using Vue.js (Vuex, Vue-router), Node.js, Express.js, MySQL, ShadCn-Vue, Tailwind, and jsPDF.

### Motivation 💡
Created QuickInvoice as a self-directed learning project, aimed at freeing users from paid, geo-restricted and complicated invoicing software.
